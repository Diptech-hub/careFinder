  ...
  return (
    <div>
      ...
      <div className="mt-20">
        ...
        <p className="flex justify-center text-sm mt-4 font-light">
          We're here to help you simplify the process and connect you with the
          care you need...
        </p>
      </div>
      <div className="flex justify-center mt-10">
        <input  type="text" placeholder="Search by Name, Address or Specialty..." className="w-96 px-4 py-2 rounded-md border border-teal-300 focus:outline-none focus:ring focus:border-teal-500 "/>
        <button className="py-2 px-4 rounded mx-4 bg-teal-500 text-white hover:bg-teal-700">Search</button>
      </div>
    </div>
  );
}
